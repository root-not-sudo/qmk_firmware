 ...
 * |        |   A  |   O  |   E  |   U  |   I  |                              |   D  |   H  |   T  |   N  |   S  |        |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |        |   ;  |   Q  |   J  |   K  |   X  | Esc  | F11  |  | F5   | Del  |   B  |   M  |   W  |   V  |   Z  |        |
 * |        |      |      |      |      |      | Alt  |CtrAlt|  | Meh  | GUI  |      |      |      |      |      |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 ...
 */
    [_PC] = LAYOUT(
      ...
      _______,   KC_SCLN,  KC_Q,     KC_J,     KC_K,    KC_X,   K_ESC,  P_RFSH,  P_FSCN,  P_DEL,  KC_B,    KC_M,    KC_W,    KC_V,   KC_Z,  _______,
    ...
    [_MAC] = LAYOUT(
      _______,   KC_QUOT,  KC_COMM,  KC_DOT,   KC_P,    KC_Y,                                      KC_F,    KC_G,    KC_C,    KC_R,   KC_L,  _______,
      _______,   KC_A,     KC_O,     KC_E,     KC_U,    KC_I,                                      KC_D,    KC_H,    KC_T,    KC_N,   KC_S,  _______,
      _______,   KC_SCLN,  KC_Q,     KC_J,     KC_K,    KC_X,   K_ESC,  M_RFSH,   M_FSCN,  M_DEL,  KC_B,    KC_M,    KC_W,    KC_V,   KC_Z,  _______,
...
static void render_status(void) {
    ...
    // Host Keyboard Layer Status -- string length max is 13
...
const rgblight_segment_t PROGMEM my_capslock_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, 4, 24, 255, 255},       // Light 2 LEDs, starting with LED 2
    {10, 4, 40, 255, 255}       // Light 2 LEDs, starting with LED 8
);
